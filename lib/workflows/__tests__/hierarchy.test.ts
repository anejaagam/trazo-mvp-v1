...
describe('hierarchy utilities', () => {
  const flatPayload = [
    { task_id: 'root', parent_id: null, title: 'Root', status: 'to_do', hierarchy_level: 0, sequence_order: 1, path: [] },
    { task_id: 'child-1', parent_id: 'root', title: 'Child 1', status: 'done', hierarchy_level: 1, sequence_order: 2, path: ['root'] },
    { task_id: 'child-0', parent_id: 'root', title: 'Child 0', status: 'blocked', hierarchy_level: 1, sequence_order: 1, path: ['root'] },
  ];
