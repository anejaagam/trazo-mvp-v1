    ...
    if (open) {
      if (cultivar && plantType === 'cannabis') {
        cannabisForm.reset({
          ...
          thc_range_min: cultivar.thc_range_min,
          thc_range_max: cultivar.thc_range_max,
          cbd_range_min: cultivar.cbd_range_min,
          cbd_range_max: cultivar.cbd_range_max,
          flowering_days: cultivar.flowering_days,
