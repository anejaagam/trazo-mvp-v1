      ...
      <div className="space-y-4">
        ...
        <div className="p-4 bg-gray-50 rounded-lg">
          ...
          <Badge className={
            ...
            genealogy.source === 'clone' ? 'bg-purple-100 text-purple-800' :
        ...
        {/* Clone Information */}
        {(genealogy.source === 'clone' || genealogy.source === 'mother_plant') && (
          <>
            ...
            {genealogy.motherPlantId && (
              <div className="p-4 bg-gray-50 rounded-lg">
                <p className="text-gray-500 mb-1">Mother Plant ID</p>
