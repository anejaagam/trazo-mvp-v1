...
### Produce Variety & Genetics Management
...
**Purpose:** Produce variety library management and batch lineage tracking for compliance.
...
**Purpose:** Produce waste tracking with proper disposal documentation and dual-approval workflow for PrimusGFS compliance.
...
- `plantCount` - tracks plant units per batch
- `mixingRatio` - waste disposal tracking (not required for produce)
