          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-900">
                {wasteLogs.reduce((sum, log) => sum + log.produceWeight, 0).toFixed(1)} lbs
              </p>
            </div>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-3">
                      <div>
                        <p className="text-gray-500">Produce Weight</p>
                        <p className="text-gray-900">{log.produceWeight} lbs</p>
                      </div>
                      <div>
                        <p className="text-gray-500">Packaging Weight</p>
                        <p className="text-gray-900">{log.packagingWeight || 0} lbs</p>
                      </div>
                      <div>
                        <p className="text-gray-500">Total Weight</p>
                        <p className="text-gray-900">{log.totalWeight} lbs</p>
                      </div>
                      <div>
          ...
          {wasteLogs.length === 0 && (
            <Card className="p-8 text-center">
              ...
              <p className="text-gray-500 mb-4">
                Create your first waste disposal log to track produce waste
              </p>
              <Button onClick={onCreateNew}>
                <Plus className="w-4 h-4 mr-2" />
              ...
              <div className="space-y-4">
                ...
                {selectedLog && (
                  <div className="p-3 bg-gray-50 rounded-lg space-y-2">
                    <div>
                      <p className="text-gray-500">Produce Weight:</p>
                      <p className="text-gray-900">{selectedLog.produceWeight} lbs</p>
                    </div>
                    <div>
                      <p className="text-gray-500">Packaging Weight:</p>
                      <p className="text-gray-900">{selectedLog.packagingWeight || 0} lbs</p>
                    </div>
                    <div>
                      <p className="text-gray-500">Total Weight:</p>
                      <p className="text-gray-900">{selectedLog.totalWeight} lbs</p>
                    </div>
                    <div>
                      <p className="text-gray-500">Created By:</p>
