...
**Location:** `Prototypes/IdentityRolesPermissionPrototype/`
...
**Location:** `Prototypes/InventoryTrackingPrototype/`
...
**Location:** `Prototypes/EnvironmentalControlsPrototype/`
...
**Location:** `Prototypes/SignUpPrototype/`
...
**Location:** `Prototypes/ItegrationsAndSSOPrototype/`
