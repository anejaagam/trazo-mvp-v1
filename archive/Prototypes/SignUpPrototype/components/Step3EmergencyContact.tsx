import svgPaths from "../imports/svg-i8dopx1581";
import imgImage3 from "figma:asset/49de8b74079c28c8a94ad91c4a5638d6fc7c566a.png";
import type { StepProps, FormData } from '../types';

type Props = StepProps<Pick<FormData, 'emergencyContactPerson' | 'emergencyContactEmail' | 'emergencyContactNumber'>>;

export default function Step3EmergencyContact({ formData, updateFormData, onNext }: Props) {
  return (
            ...
            <div className="max-w-[960px] mx-auto">
              <div className="flex flex-col py-[20px]">
                ...
                <div className="p-[16px]">
                  <p className="font-['Inter:Medium',_sans-serif] font-medium leading-[24px] text-[#0d1c0d] text-[16px] mb-[12px]">Step 3 of 4</p>
                  <div className="bg-[#d1e8d1] rounded-[4px] w-full">
                    <div className="bg-[#17cf17] h-[8px] rounded-[4px] w-[696px]" />
                  </div>
                </div>

                {/* Title */}
                <div className="py-[20px] px-[16px] pb-[12px]">
                  <p className="font-['Inter:Bold',_sans-serif] font-bold leading-[35px] text-[#0d1c0d] text-[28px] text-center">Emergency Contact Details</p>
                </div>

                {/* Emergency Contact Person Field */}
                <div className="px-[16px] py-[12px] max-w-[480px]">
                  <div className="mb-[8px]">
                    <p className="font-['Inter:Medium',_sans-serif] font-medium leading-[24px] text-[#0d1c0d] text-[16px]">Emergency Contact Person</p>
                  </div>
                  <div className="flex items-start rounded-[8px]">
                    <input
                      type="text"
                      value={formData.emergencyContactPerson}
                      onChange={(e) => updateFormData('emergencyContactPerson', e.target.value)}
                ...
                <div className="px-[16px] py-[12px] max-w-[480px]">
                  <div className="mb-[8px]">
                    <p className="font-['Inter:Medium',_sans-serif] font-medium leading-[24px] text-[#0d1c0d] text-[16px]">Emergency Contact Email</p>
                  </div>
                  <div className="flex items-start rounded-[8px]">
                    <input
                      type="email"
                ...
                <div className="px-[16px] py-[12px] max-w-[480px]">
                  <div className="mb-[8px]">
                    <p className="font-['Inter:Medium',_sans-serif] font-medium leading-[24px] text-[#0d1c0d] text-[16px]">Emergency Contact Number</p>
                  </div>
                  <div className="flex items-start rounded-[8px]">
                    <input
                      type="tel"
                ...
                {/* Next Button */}
                <div className="flex justify-center pt-[82px] pb-[21px] px-[16px]">
                  <button
                    onClick={onNext}
